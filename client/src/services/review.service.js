...
const RService = {
    ...
    update(id, body) {
        console.log(id)
        return axios.patch(`${process.env.REACT_APP_API_URL}review/${id}`, body, { headers: authHeader() });
    },
    delete(id) {
    ...
    listOwnedReviews(id) {
        return axios.put(`${process.env.REACT_APP_API_URL}helperReview/${id}`, { headers: authHeader() });
    }
};
